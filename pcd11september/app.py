...
def puzzle():
    ...
    return render_template("kuis.html", puzzle_piece_paths=puzzle_piece_paths)
...
@app.route("/sizephoto", methods=["POST"])
@nocache
def sizephoto():
    width, height = image_processing.sizePhoto()
    return render_template('uploaded.html', width=width, height=height, file_path="img/img_now.jpg")
...
def show_image_values():
    ...
    return render_template("uploaded.html", pixel_values=pixel_values, width=width, height=height)
